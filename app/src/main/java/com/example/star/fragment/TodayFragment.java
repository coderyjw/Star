...
public class TodayFragment extends   Fragment{
    ...
    private void requestData(final String star) {
        HttpUtil.sendOkHttpRequest(HttpUtil.BASE_URL + star, new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                try {
                    ...
                    editor.putString("res_body_today"+Utility.star, jsonData);
                    editor.apply();
                    showStarInfo(res_body);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                Runnable runnableUi = new Runnable() {
                    ...
                    @Override
                    public void run() {
                        titleDateText.setText(Utility.ConvertToData(res_body.getDay().getTime()));
                        textStar.setText(Utility.ConvertToStar(res_body.getStar()));
                        summaryStar.setRating(res_body.day.getSummary_star());
                        loveStar.setRating(res_body.day.getLove_star());
                        workStar.setRating(res_body.day.getWork_star());
                        moneyStar.setRating(res_body.day.getMoney_star());
                        luckyTime.setText(Utility.ConvertToTime(res_body.day.getLucky_time()));
                        luckyDirection.setText(res_body.day.getLucky_direction());
                        luckyColor.setText(res_body.day.getLucky_color());
                        grxz.setText(res_body.day.getGrxz());
                        luckyNum.setText(res_body.day.getLucky_num());
                        generalTxt.setText(res_body.day.getGeneral_txt());
                        loveTxt.setText(res_body.day.getLove_txt());
                        workTxt.setText(res_body.day.getWork_txt());
                        moneyTxt.setText(res_body.day.getMoney_txt());
                        dayNotice.setText(res_body.day.getDay_notice());
