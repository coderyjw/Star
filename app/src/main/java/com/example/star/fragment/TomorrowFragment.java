        ...
        new Thread() {
            ...
            public void run() {
                ...
                Runnable runnableUi = new Runnable() {
                    @Override
                    public void run() {
                        titleDateText.setText(Utility.ConvertToData(res_body.tomorrow.getTime()));
                        textStar.setText(Utility.ConvertToStar(res_body.getStar()));
                        // summaryStar.setText(res_body.tomorrow.getSummary_star() + "");
                        summaryStar.setRating(res_body.tomorrow.getSummary_star());
                        loveStar.setRating(res_body.tomorrow.getLove_star());
                        workStar.setRating(res_body.tomorrow.getWork_star());
                        moneyStar.setRating(res_body.tomorrow.getMoney_star());
                        luckyTime.setText(Utility.ConvertToTime(res_body.tomorrow.getLucky_time()));
                        luckyDirection.setText(res_body.tomorrow.getLucky_direction());
                        luckyColor.setText(res_body.tomorrow.getLucky_color());
                        grxz.setText(res_body.tomorrow.getGrxz());
                        luckyNum.setText(res_body.tomorrow.getLucky_num());
                        generalTxt.setText(res_body.tomorrow.getGeneral_txt());
                        loveTxt.setText(res_body.tomorrow.getLove_txt());
                        workTxt.setText(res_body.tomorrow.getWork_txt());
                        moneyTxt.setText(res_body.tomorrow.getMoney_txt());
                        dayNotice.setText(res_body.tomorrow.getDay_notice());
